...
<center>
    <img src={require("./img/stack.webp").default} width="400px" alt="" />
</center>
...
Mosaico provides a series of [Ontology Models](https://docs.mosaico.dev/SDK/ontology) for all the main sensors and applications in robotics. These are specific data structures representing a single data type. For example, a GPS sensor might be modeled as follows:
...
Users can easily extend the platform by defining their own [Ontology Models](https://docs.mosaico.dev/SDK/ontology). 
...
<center>
     <img src={require("./img/stack.png").default} width="500px" alt="" />
</center>